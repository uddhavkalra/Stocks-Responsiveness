...
My sample extends from January 1, 2021 to March 31, 2025 with a total of 17 quarters. The sample starts from 2021 to avoid affects of COVID-19. In total, there are 3502 unique stocks in the dataset.
...
Since index-tracking funds must replicate the S\&P 500 composition, inclusion in the index mechanically increases passive fund demand for the stock, making it a relevant instrument. The instrument variable is a dummy variable equal to 1 if a stock at time $t$ was in the S\&P 500 index and 0 otherwise.
